...
namespace HealthAxisTests.RepositoryTests
{
    public class AppointmentRepositoryTests
    {
        ...
        public void Add_ShouldCreateAppointment()
        {
            ...
            var result = _repo.AddAppointment(appointment);
        ...
        public void GetById_ShouldReturnAppointment()
        {
            ...
            var appointment = _repo.AddAppointment(new Appointment
            {
                Patient = patient,
                Doctor = doctor,
                ScheduledDate = DateTime.Today,
            ...
            var result = _repo.GetAppointmentById(appointment.AppointmentId);
        ...
        public void GetAll_ShouldReturnOrderedAppointments()
        {
            ...
            _repo.AddAppointment(new Appointment
            {
                Patient = patient,
                Doctor = doctor,
                ScheduledDate = DateTime.Today,
